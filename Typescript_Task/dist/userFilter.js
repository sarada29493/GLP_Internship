...
const miniStore_1 = require("./miniStore");
...
const store = new miniStore_1.MiniStore();
...
function processText(text, forbiddenWord) {
    ...
    const isForbidden = (word, forbidden) => word.toLowerCase() === forbidden.toLowerCase();
